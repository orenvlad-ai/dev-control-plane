...
[[ "$DCP_AO_FORK_PR_URL" == 'https://github.com/orenvlad-ai/dcp-orchestrator/pull/60' ]]
[[ "$DCP_AO_FORK_COMMIT" == f857fc652a529955a3bca4205c09961a1a80b811 ]]
[[ "$DCP_AO_FORK_TREE" == ce8d2a4af467faf7c816152d04ac8a423eeb1b3b ]]
[[ "$DCP_AO_PRIOR_FORK_COMMIT" == 2430e6268281a750f843057acf3084193efacdc5 ]]
[[ "$DCP_AO_PRIOR_FORK_TREE" == 3c349323207913574d22a7905441cb9628d7faf0 ]]
...
grep -Fq 'wb-price-extension --profile repo-only --task-id task-id' lib/dcp-ao-adapter.sh
grep -Fq 'https://github.com/orenvlad-ai/wb-price-extension.git' lib/dcp-ao-adapter.sh
grep -Fq 'orenvlad-ai/wb-price-extension|false|main|1335072844|237411244' lib/dcp-ao-adapter.sh
...
grep -Fq '"$cli" dcp submit --target wb-price-extension --profile repo-only' lib/dcp-ao-adapter.sh
grep -Fq -- '--repository orenvlad-ai/wb-price-extension' lib/dcp-ao-adapter.sh
grep -Fq 'DCP repo-only profile v1' lib/dcp-ao-adapter.sh tests/fixtures/fake-ao
grep -Fq 'dcp_ao_validate_repo_only_target "$lab_root" 0' lib/dcp-ao-common.sh
...
grep -Fq 'evidence_status: technical-complete' docs/I18_CARD13_ADMISSION_STATUS_DOT_REPAIR_SUCCESS_EVIDENCE.md
grep -Fq '5f8ce03ca79da650c23c4968eae2e1e9c3deed05dcd57c6d08e108bbe2c6a782' docs/I18_CARD13_ADMISSION_STATUS_DOT_REPAIR_SUCCESS_EVIDENCE.md
grep -Fq '1b3f9fb266370326bbb35283fb51fb5226502c42' docs/I18_CARD13_ADMISSION_STATUS_DOT_REPAIR_SUCCESS_EVIDENCE.md
...
grep -Fq 'evidence_status: technical-complete' docs/DCP_REAL_TARGET_V1_INSTALL_EVIDENCE.md
grep -Fq '06ebdbf6c418ed3805ff85737a638cf9e78cf5f70a1b035211016c0b117d26fc' docs/DCP_REAL_TARGET_V1_INSTALL_EVIDENCE.md AGENTS.md docs/CURRENT_OPERATING_CONTRACT.md docs/PROJECT_BRIEF.md docs/UPSTREAM_QUALIFICATION.md
grep -Fq 'live_dcp_tasks_created: 0' docs/DCP_REAL_TARGET_V1_INSTALL_EVIDENCE.md
grep -Fq 'additional_model_actions: 0' docs/DCP_REAL_TARGET_V1_INSTALL_EVIDENCE.md
grep -Fq -- '--target wb-price-extension --profile repo-only' docs/DCP_REAL_TARGET_V1_INSTALL_EVIDENCE.md
grep -Fq 'evidence_status: technical-complete' docs/DCP_REAL_TARGET_PROVIDER_IDENTITY_V1_TERMINAL_EVIDENCE.md
grep -Fq 'live_dcp_tasks_created: 0' docs/DCP_REAL_TARGET_PROVIDER_IDENTITY_V1_TERMINAL_EVIDENCE.md
grep -Fq 'additional_model_actions: 0' docs/DCP_REAL_TARGET_PROVIDER_IDENTITY_V1_TERMINAL_EVIDENCE.md
grep -Fq '9162d4c0eca9efd2a3d9fe1ad09d640c40738c47' docs/DCP_REAL_TARGET_PROVIDER_IDENTITY_V1_TERMINAL_EVIDENCE.md AGENTS.md docs/CURRENT_OPERATING_CONTRACT.md docs/PROJECT_BRIEF.md docs/UPSTREAM_QUALIFICATION.md
grep -Fq '5cb06d6edaeb70080999f531da76109936732a57bee8262d9c0cf0af1b7ce295' docs/DCP_REAL_TARGET_PROVIDER_IDENTITY_V1_TERMINAL_EVIDENCE.md AGENTS.md docs/CURRENT_OPERATING_CONTRACT.md docs/DECISIONS.md docs/UPSTREAM_QUALIFICATION.md
grep -Fq 'evidence_status: COMPLETE' docs/DCP_REAL_TARGET_SUBMIT_RECOVERY_V1_TERMINAL_EVIDENCE.md
grep -Fq '62853496837f64522bb08ba56169f60f3b0f9a2c' docs/DCP_REAL_TARGET_SUBMIT_RECOVERY_V1_TERMINAL_EVIDENCE.md AGENTS.md docs/CURRENT_OPERATING_CONTRACT.md docs/PROJECT_BRIEF.md docs/ROADMAP.md docs/DECISIONS.md docs/UPSTREAM_QUALIFICATION.md
grep -Fq '2c38e353acb0a1e9a136a5ab77fcc2b2d49b970cede673d215daf092484df3dd' docs/DCP_REAL_TARGET_SUBMIT_RECOVERY_V1_TERMINAL_EVIDENCE.md AGENTS.md docs/CURRENT_OPERATING_CONTRACT.md
grep -Fq 'Total truthful model tokens are 47,885' docs/DCP_REAL_TARGET_SUBMIT_RECOVERY_V1_TERMINAL_EVIDENCE.md
...
bash -n bin/dcp-ao bin/dcp-ao-submit lib/dcp-ao-common.sh lib/dcp-ao-gateway.sh lib/dcp-ao-install.sh lib/dcp-ao-adapter.sh tests/test_i3.sh tests/test_repo_only_stopped_sqlite.sh tests/test_i8_gateway.sh tests/test_i12_install.sh tests/test_i12_codex_preflight.sh tests/fixtures/fake-ao tests/fixtures/codex-preflight/codex
tests/test_i3.sh
