...
[[ "$DCP_AO_FORK_PR_URL" == 'https://github.com/orenvlad-ai/dcp-orchestrator/pull/17' ]]
[[ "$DCP_AO_FORK_COMMIT" == 56aa7ed2eb04ae9d7fdd5d5aadb854d3160af44e ]]
[[ "$DCP_AO_FORK_TREE" == fe31bf034e56192f6306ce23f4b16b4b6a990877 ]]
[[ "$DCP_AO_PRIOR_FORK_COMMIT" == f23ee9a9cbc8be57710b4dd6c95a23bf0fb52b24 ]]
[[ "$DCP_AO_PRIOR_FORK_TREE" == 67a084e9e546a725b0b19b3074ba205f6c03fa82 ]]
