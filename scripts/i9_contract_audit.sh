...
grep -Fq 'fbcf4929f9192f7cce9c5097b0bc6a449d28e663' docs/CURRENT_OPERATING_CONTRACT.md docs/PROJECT_BRIEF.md docs/DECISIONS.md docs/UPSTREAM_QUALIFICATION.md
