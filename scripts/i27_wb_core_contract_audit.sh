...
grep -Fq 'technical status remains `BLOCKED` pending reviewed merge' "$contract"
grep -Fq 'current_readiness_status: blocked-native-normalization-guard-merge' "$contract"
...
grep -Fq 'operating_contract_revision: 2026-08-17.5' "$current"
