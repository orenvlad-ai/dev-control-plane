...
grep -Fq 'contract_revision: 2026-08-20.3' docs/DCP_WBC_INTEGRATION_TWIN_STAGE5_INSTALL_ACTIVATION_CONTRACT.md
grep -Fq 'operating_contract_revision: 2026-08-20.8' docs/CURRENT_OPERATING_CONTRACT.md
