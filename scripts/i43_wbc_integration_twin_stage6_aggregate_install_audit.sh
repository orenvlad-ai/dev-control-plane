...
grep -Fq 'manifest_revision: 2026-08-22.2' "$manifest"
grep -Fq 'program_status: Stage 6 BLOCKED; direct-model source installed at schema 86 and stopped, adoption/live continuation not authorized' "$manifest"
